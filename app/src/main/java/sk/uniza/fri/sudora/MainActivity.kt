...
class MainActivity : AppCompatActivity() {
    ...
    private fun readDataToViewModel(){
        ...
        val numberOfPinnedNotes = sharedPrefs.getInt("maxPinnedPos", 0)

        val type = object: TypeToken<MutableList<Note?>>() {}.type
        viewModel.addToViewModel(gson.fromJson(noteJSON, type), gson.fromJson(archiveJSON, type), gson.fromJson(trashJSON, type), numberOfPinnedNotes)
    }
}